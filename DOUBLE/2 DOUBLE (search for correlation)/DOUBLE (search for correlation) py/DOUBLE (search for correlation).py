...
N = [[s.bitvec('N_'+str(i)+'_'+str(j),1) for j in range(16)] for i in range(8)]
...
# multiple solving
def ms(times):
    ff = open('DOUBLE (search for correlation).txt', 'a')
...
AES_P(w13,gamma0)
AES_P(w14,gamma1)
Sbox('e12','w1','A','SA','S1')            # S-boxes
Sbox('e22','w2','B','SB','S2')
Sbox('c0','w3','C','SC','S3')
Sbox('c1','w4','D','SD','S4')
Sbox('alpha0','w5','E','SE','S5')
Sbox('alpha1','w6','F','SF','S6')
Sbox('v3','w7','G','SG','S7')
Sbox('v4','w8','H','SH','S8')
Sbox('c0','w9','I','SI','S9')
Sbox('c1','w10','J','SJ','S10')
Sbox('v5','w11','K','SK','S11')
Sbox('v6','w12','L','SL','S12')
Sbox('e13','w13','M','SM','S13')
Sbox('e23','w14','N','SN','S14')

#cond()                                     # condition
obj(15400)                                # objective function
ms(1)
